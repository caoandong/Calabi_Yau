...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1en6 = RealNumber('1e-6'); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_1p0 = RealNumber('1.0'); _sage_const_10 = Integer(10); _sage_const_46 = Integer(46); _sage_const_16p0 = RealNumber('16.0'); _sage_const_50 = Integer(50); _sage_const_27 = Integer(27); _sage_const_0p000001 = RealNumber('0.000001')
import math
import numpy as np
import scipy
...
def NSolve(Series, d, bound, out_file):
    ...
    b1_max = bound[_sage_const_0 ]
    b2_max = bound[_sage_const_1 ]
    b3_max = bound[_sage_const_2 ]
    ...
    while const == _sage_const_0 :
        ...
        count += _sage_const_1 
        d1_0 = np.random.uniform(low=_sage_const_0 , high=b1_max)
        d2_0 = np.random.uniform(low=_sage_const_0 , high=b2_max)
        d3_0 = np.random.uniform(low=_sage_const_0 , high=b3_max)
...
def expand_NSolve(Series, max_range, vol_range, out_file):
    ...
    vol = -_sage_const_1 
    sol = -_sage_const_1 
    vol_list_pos = [-_sage_const_1 , -_sage_const_1 ]
    vol_list_neg = [-_sage_const_1 , -_sage_const_1 ]
    vol_list_out = [-_sage_const_1 , -_sage_const_1 ]
    if len(vol_list) != _sage_const_0  and len(sol_list) != _sage_const_0 :
        for i in range(len(vol_list)):
            ...
            if abs(dist) > max_diff:
                ...
                if abs(dist) < abs(target_vol - vol_list_out[_sage_const_0 ]):
                    vol_list_out = [vol_tmp, sol_tmp]
                continue
            if dist > _sage_const_0 :
                print 'vol is smaller than target'
                if abs(dist) < abs(target_vol - vol_list_pos[_sage_const_0 ]):
                    vol_list_pos = [vol_tmp, sol_tmp]
                continue
            if dist < _sage_const_0 :
                print 'vol is greater than target'
                if abs(dist) < abs(target_vol - vol_list_neg[_sage_const_0 ]):
                    vol_list_neg = [vol_tmp, sol_tmp]
                continue
    if vol_list_pos[_sage_const_0 ] != -_sage_const_1  and type(vol_list_pos[_sage_const_1 ]) != int:
        print 'good'
        return vol_list_pos[_sage_const_0 ], vol_list_pos[_sage_const_1 ]
    if vol_list_neg[_sage_const_0 ] != -_sage_const_1  and type(vol_list_neg[_sage_const_1 ]) != int:
        print 'meh'
        return vol_list_neg[_sage_const_0 ], vol_list_neg[_sage_const_1 ]
    if vol_list_out[_sage_const_0 ] != -_sage_const_1  and type(vol_list_out[_sage_const_1 ]) != int:
        print 'nah'
        return vol_list_out[_sage_const_0 ], vol_list_out[_sage_const_1 ]
...
def generate_vol(min_height, max_height, max_range, out_file):
    ...
    for h1 in range(min_height, max_height+_sage_const_1 ):
        ...
        vol, sol = expand_NSolve(series, _sage_const_5 , [target_vol, max_range], out_file)
        print 'vol: ', vol
...
print series
'''
vol_min_global = _sage_const_1 
input_min_height = _sage_const_46 
input_max_height = _sage_const_50 
...
vol_list = generate_vol(input_min_height, input_max_height, _sage_const_5 , out_file)
out_file.close()
print 'completed.'
