...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1en6 = RealNumber('1e-6'); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_29 = Integer(29); _sage_const_99999 = Integer(99999); _sage_const_1p0 = RealNumber('1.0'); _sage_const_999 = Integer(999); _sage_const_10 = Integer(10); _sage_const_16p0 = RealNumber('16.0'); _sage_const_0p03 = RealNumber('0.03'); _sage_const_0p02 = RealNumber('0.02'); _sage_const_4p62386348 = RealNumber('4.62386348'); _sage_const_27 = Integer(27); _sage_const_24 = Integer(24); _sage_const_0p000001 = RealNumber('0.000001')
import math
import numpy as np
import scipy
...
def generate_vol_3(h_list, out_path, vol_dict, max_range=_sage_const_0p02 ):
    global vol_min_global
    vol_list = []
    num_vol = _sage_const_0 
    min_height = h_list[_sage_const_0 ]
    if min_height%_sage_const_2  == _sage_const_0 :
        max_height = min_height + _sage_const_1 
    else:
        max_height = h_list[_sage_const_0 ]
...
def parse_data(data_path):
    ...
    for path in data_path:
        ...
        for line in data_file:
            data = eval(line)
            h = data[_sage_const_0 ]
            vol = data[_sage_const_1 ]
            vol_dict['%d_%d_%d' % (h[_sage_const_0 ],h[_sage_const_1 ],h[_sage_const_2 ])] = vol
    return vol_dict
...
#out_file.close()
'''
h_start = [_sage_const_29 ,_sage_const_29 ,_sage_const_24 ]
out_path = 'lift_vol_%d_%d_%d.txt'%(h_start[_sage_const_0 ], h_start[_sage_const_1 ], h_start[_sage_const_2 ])
out_file = open(out_path, 'w')
out_file.close()
