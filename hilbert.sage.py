...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_1p0 = RealNumber('1.0'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_2p0 = RealNumber('2.0'); _sage_const_1en10 = RealNumber('1e-10'); _sage_const_3p0 = RealNumber('3.0')
import math
import numpy as np
import scipy
...
def find_face(p, pts):
    ...
    num_pts = len(pts)
    if num_pts == _sage_const_1 :
        P1 = Polyhedron(vertices = [tuple(pts)])
    else:
        P1 = Polyhedron(pts)
    faces = []
    for face in P1.faces(_sage_const_2 ):
...
def find_adj(pt, face_pts):
    ...
    if num_face_pts < _sage_const_3 :
        raise ValueError('Face %s has too little points.' % face_pts)
    
    # pick 2 points from the face (arbitrary)
    c = find_center(face_pts[_sage_const_0 ], face_pts[_sage_const_1 ], face_pts[num_face_pts - _sage_const_1 ])
    c = np.array(c)
    #print 'center: ', c
    pt = np.array(pt)
    ...
    #print 'dist: ', dist
    len_dist = len(dist)
    stop = _sage_const_0  # Stop sign to stop the while loop
    
    while stop == _sage_const_0 :
        # Sort the distance list
        dist_sort = sorted(dist)
        #print 'dist_sort: ', dist_sort
        sort_1 = dist_sort[_sage_const_1 ]
        sort_2 = dist_sort[_sage_const_2 ]
        if sort_1 == sort_2:
            id1 = dist.index(sort_1)
            dist[id1] = _sage_const_0 
...
def Triang(pts):
    ...
    vol_check = _sage_const_0 
    
    while vol_check == _sage_const_0 :
        vol_check = _sage_const_1 
        triang_ret = []
        for tetra in triang:
            print 'tetrahedron: ', tetra
            tet = Polyhedron(tetra)
            vol = tet.volume()
            if vol > _sage_const_1 /_sage_const_6 :
                vol_check = _sage_const_0 
                ...
                for p in pts:
                    if p in tetra:
                        ...
                        continue
                    if contain(tet, p) == _sage_const_1 :
...
pts = [[_sage_const_0p0 , _sage_const_0p0 , _sage_const_3p0 ], [_sage_const_0p0 , _sage_const_3p0 , _sage_const_0p0 ], [_sage_const_0p0 , _sage_const_3p0 , _sage_const_3p0 ], [_sage_const_3p0 , _sage_const_0p0 , _sage_const_0p0 ], [_sage_const_3p0 , _sage_const_3p0 , _sage_const_0p0 ], [_sage_const_3p0 , _sage_const_3p0 , _sage_const_3p0 ], [_sage_const_0p0 , _sage_const_0p0 , _sage_const_1p0 ], [_sage_const_0p0 , _sage_const_1p0 , _sage_const_0p0 ], [_sage_const_1p0 , _sage_const_0p0 , _sage_const_0p0 ], [_sage_const_2p0 , _sage_const_0p0 , _sage_const_3p0 ], [_sage_const_3p0 , _sage_const_0p0 , _sage_const_2p0 ], [_sage_const_3p0 , _sage_const_1p0 , _sage_const_3p0 ]]
triang = Triang(pts)
out_file.write("%s\n" % triang)
out_file.close()
